package com.hisarhospital.hisar_hospital_api.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private static final List<String> PUBLIC_URLS = List.of("/login", "/login", "/patients/register", "/verify-otp", "/send-reset-otp", "/reset-password", "/logout");
    @Override
